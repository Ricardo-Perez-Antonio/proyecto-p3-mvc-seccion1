<head>
    ...
    <link rel="stylesheet" href="./css/cliente_new.css">
</head>
<?php
...
?>
<body>
<form action="./php/mecanico_editar.php" method="post" autocomplete="off">
        <h2>EDITAR MECANICO</h2>

        <input type="hidden" name="mecanico_id" value="<?php echo $datos['mecanico_id'];?>" required>
